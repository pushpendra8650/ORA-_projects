        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#"> pushpendra1212088@gmail.com</a></span>
                </div>
            </li>
...
<!-- ============================================================= INFORMATION : END ============================================================= -->            	</div><!-- /.col -->
    ...
    <div style="background-color:#abd07e; color:#FFF; font-weight:bold; font-size:14px; text-align:center;">
    	Developed by Pushpendra kumar sharma & Ranu pandey<br />
