...
{
$sql=mysqli_query($bd,"SELECT password FROM  users where password='".md5($_POST['password'])."' && mobile='".$_SESSION['ologin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd,"update users set password='".md5($_POST['newpassword'])."' where mobile='".$_SESSION['ologin']."'");
